...
.. literalinclude:: ../../tests/docs/usage/examples/componentsA.py
    :end-before: end-before
...
.. literalinclude:: ../../tests/docs/usage/examples/componentsF.py
    :end-before: end-before
...
.. literalinclude:: ../../tests/docs/usage/examples/componentsG.py
    :end-before: end-before

Subcomponents are also feasible.
They make up part of both the VDOM and the rendering:

.. literalinclude:: ../../tests/docs/usage/examples/componentsH.py
    :end-before: end-before
