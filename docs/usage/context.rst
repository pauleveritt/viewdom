...
React has addressed this with a number of technologies over the years, including `Context <https://reactjs.org/docs/context.html>`_ and `Hooks <https://reactjs.org/docs/hooks-intro.html>`_.
...
.. literalinclude:: ../../tests/docs/usage/examples/contextA.py
    :end-before: end-before
...
``Context`` uses `thread-local data <https://docs.python.org/3.8/library/threading.html#thread-local-data>`_ which is a Python system for storing data in a thread and making it accessible to anything that grabs it.
